...
FB.ensureInit(function(){
	FB.Connect.ifUserConnected( function() {
		jQuery('#sfc-fb-button').html('<input class="button-primary" type="button" onclick="FB.Connect.logoutAndRedirect(\'wp-login.php\');" value="Logout of Facebook Connect" />');
	}, function() {
		jQuery('#sfc-fb-button').html('<fb:login-button v="2"	onlogin="location.reload(true);"><fb:intl>Connect with Facebook</fb:intl></fb:login-button>');
